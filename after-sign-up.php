...
<div class="popWrap clearfix messagePopup">
    ...
    <div class="topArea">
        <h1>Almost Done!</h1>
        <p>We need a few more things to set your account</p>
    </div>
      <form id="register">
       <label class="labelTxt">Full Name</label>
       <input type="text">

       <label class="labelTxt">Choose your username</label>
       <input type="text">
       <span class="placeHolder">Your Rebel page: http://www.rebelsmarket.com/yourpage</span>

       <label class="labelTxt">Create a Password</label>
       <input name="password" type="password" class="password" id="password" />
        
        <section class="passMain clearfix">
          <span class="txt">Password strength</span>
       ...
       <p class="notice2">By creating an account, I accept RebelsMarket 's <br>
<a href="">Terms of Service </a> and <a href="">Privacy Policy </a> </p>

       <div class="buttonSpace clearfix resett">
