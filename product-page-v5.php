...
<div id="content">
  ...
  <div class="container headerMarginTop">
		...
		<section class="prdctContent">
			 <div class="titleBlock">
				<h1>The Finest Collection of Steampunk Jewelry</h1>
				<p>
			 ...
			 <article class="clearfix">
				<div class="leftBlock"> 
					<a href="#"><img src="img/4d-product_page.jpg" border="0" /></a>
				 </div>
				
				<div class="rightBlock">
				<h1>Today's Best Sellers</h1>
				<div class="colGrp clearfix">
					<div class="colImg">
						<img src="img/product_img.jpg" />
					</div>
					<div class="colDesc">
						<h2><a href="#">Lorem ipsum</a></h2>
						<h4>$30 <span>$39</span></h4>
			 ...
			 <article class="popularNow prdctShow">
		  ...
		  <div class="column column-3 galry-item">
			...
			<div class="share-popup">
			 ...
			 <div class="titleBlock borderNone">
				<h1>Contrary to popular belief</h1>
				<p>
					Choose from the biggest & finest collection pf steampunk jewelry at Rebelsmarket. We've got everything from diamond , gold silver, wood and stainless steel necklaces to crucifixes, crossed, rosaries and even heart and even key necklace. whatever be the occasion, if it's Speampunk jewelry you're looking for, we've probably got it
				</p>
